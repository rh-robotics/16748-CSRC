...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 3.16347833; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 3.19631072592; // Multiplier in the Y direction
